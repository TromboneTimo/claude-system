...
2. **Testimonial with specific outcome number.** "The routine that built my range" (2.5%, 103 clicks), "My sound got 20% bigger from this" (1.5%), "What Happened When Brian Joined Victor Alegria Music" (1.5%)
...
- "Reminder: Victor Alegria Music FREE TRUMPET CLASS!" (7x at 0.56% avg)
