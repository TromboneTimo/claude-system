...
Harrisson Ball
{credential line if formal email: "CEO, Victor Alegria Music / Featured in Forbes"}

P.S. {P.S. text matching declared P.S. type}
```

**CTA URL placeholder:** `[VICTOR_DOMAIN_PLACEHOLDER]/{path}?el=email_{slug}`
...
I'll run /va-email-push to land them in dashboard/emails.html.
```
