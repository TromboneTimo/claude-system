...
- **Memory pointer:** `/Users/air/.claude/projects/-Users-air-Desktop-Victor-Alegria-Music/memory/project_proven_converter_template.md` (the 12-move template, distilled)
- **Full transcript:** `/Users/air/Desktop/Victor Alegria Music/references/converting-video-embouchure-transcript.md`
- **YouTube database entry:** `/Users/air/Desktop/Victor Alegria Music/voc/youtube/raw/2026-04_embouchure-truth_O4a-q93ENAg/`
...
This skill is forward-compatible. As `voc/youtube/raw/index.json` accumulates more `status=winner` entries, Agent A reads ALL of them and extracts patterns common across multiple winners (not just the embouchure video). Cross-winner patterns are stronger signal than single-video patterns. Update this file's "Where the source files live" section as new winners come in.
...
- **Database path:** `/Users/air/Desktop/Victor Alegria Music/voc/meta-ads/`
