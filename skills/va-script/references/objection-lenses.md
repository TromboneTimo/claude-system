...
Sourced from coaching-db's `mine-angles.md` and Victor Alegria Music's `voc/synthesis/objection-library.md`.
...
- If the objection was already directly addressed in a YouTube winner, pick a different lens. (Cross-check `voc/youtube/raw/index.json` topic_tags.)
